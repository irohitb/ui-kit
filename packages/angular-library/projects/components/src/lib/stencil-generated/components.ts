...
@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['canSendFiles', 'canSendTextMessage', 'disableEmojiPicker', 'iconPack', 'inputTextPlaceholder', 'isEditing', 'message', 'quotedMessage', 'storageKey', 't']
})
@Component({
...
export declare interface DyteDebuggerAudio extends Components.DyteDebuggerAudio {
   ...
   * Test Progress Event 
   */
  testProgress: EventEmitter<CustomEvent<number>>;
...
export declare interface DyteDebuggerIssuesUi extends Components.DyteDebuggerIssuesUi {}
...
export class DyteDebuggerIssuesUi {
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
...
export declare interface DyteDebuggerNetwork extends Components.DyteDebuggerNetwork {}
...
export declare interface DyteDebuggerPermissionsUi extends Components.DyteDebuggerPermissionsUi {}
...
export class DyteDebuggerPermissionsUi {
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
...
import type { States as IDyteRemoteAccessManagerStates } from '@dytesdk/ui-kit';
export declare interface DyteRemoteAccessManager extends Components.DyteRemoteAccessManager {
  /**
   * Emits updated state data 
   */
  dyteStateUpdate: EventEmitter<CustomEvent<IDyteRemoteAccessManagerStates>>;
...
@Component({
  selector: 'dyte-remote-access-manager',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['iconPack', 'meeting', 'size', 'states', 't']
})
...
@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['disabled', 'keyDownHandler', 'maxLength', 'placeholder', 'value'],
  methods: ['setText']
})
@Component({
...
export declare interface DyteWebinarStageToggle extends Components.DyteWebinarStageToggle {}
