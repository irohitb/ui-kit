...
export class DyteGrid {
  ...
  private networkUpdateListener = ({ event }) => {
  ...
  @State() meetingConnected: boolean = true;

  @State() mediaConnected: boolean = true;

  @State() roomState: 'init' | 'joined' | 'waitlisted' | leaveRoomState;
